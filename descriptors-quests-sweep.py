...
def main():
    ...
    if args.cosine:
        print("Using entropy with cosine distance.")
    ...
    X_train = get_descriptors(train_frames_list, k=args.k, cutoff=args.cutoff)
    ...
    for test_set in test_sets:
        ...
        if train_set == test_set and not args.strain:
            ...
            X_test = get_descriptors(test_frames_list, k=args.k, cutoff=args.cutoff)
