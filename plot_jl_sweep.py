...
# Load JSONL data
# ----------------------------
data_path = "/home/grethel/dev/quests/npy_files/jl_entropy_results.jsonl"
...
# Axes formatting
# ----------------------------
ax.set_title("Dataset Entropy (ACEPotentials.jl)", fontsize=14)
...
output_file = Path("sweep_plots/jl_entropy_all_curves_rainbow.png")
